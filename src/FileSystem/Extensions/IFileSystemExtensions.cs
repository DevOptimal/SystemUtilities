...
namespace DevOptimal.SystemUtilities.FileSystem.Extensions
{
    ...
    public static class IFileSystemExtensions
    {
        extension(IFileSystem fileSystem)
        {
            ...
            public void HardLinkFile(string sourcePath, string destinationPath)
            {
                if (fileSystem == null) throw new ArgumentNullException(nameof(fileSystem));
            ...
            public StreamReader OpenFileText(string path)
            {
                if (fileSystem == null) throw new ArgumentNullException(nameof(fileSystem));
            ...
            /// <param name="encoding">The encoding to use.</param>
            /// <returns>The file contents as a string.</returns>
            public string ReadAllTextFromFile(string path, Encoding encoding)
            {
                if (fileSystem == null) throw new ArgumentNullException(nameof(fileSystem));
            ...
            public void WriteAllLinesToFile(string path, IEnumerable<string> lines)
            {
                if (fileSystem == null) throw new ArgumentNullException(nameof(fileSystem));
            ...
            /// <param name="lines">The lines to write.</param>
            /// <param name="encoding">The encoding to use.</param>
            public void WriteAllLinesToFile(string path, IEnumerable<string> lines, Encoding encoding)
            {
                if (fileSystem == null) throw new ArgumentNullException(nameof(fileSystem));
            ...
            /// <param name="path">The file path to write to.</param>
            /// <param name="lines">The lines to write.</param>
            public void WriteAllLinesToFile(string path, string[] lines)
            {
            ...
            /// <param name="lines">The lines to write.</param>
            /// <param name="encoding">The encoding to use.</param>
            public void WriteAllLinesToFile(string path, string[] lines, Encoding encoding)
            {
