...
namespace DevOptimal.SystemUtilities.FileSystem.Comparers
{
    public class LinuxFileSystemInfoComparer : IEqualityComparer<FileSystemInfo>
    {
        public bool Equals(FileSystemInfo x, FileSystemInfo y)
        {
            ...
            {
                return x.FullName.TrimEnd(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar).Equals(y.FullName.TrimEnd(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar), StringComparison.Ordinal);
            }
        }
